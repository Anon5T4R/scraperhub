# VENDIDO: extractor do Blogger refeito do PR yt-dlp#17129 (nao mesclado
# ainda; corrige "Unable to extract JSON data" no player video.g). Aplicado
# em runtime por app/vendor/__init__.py (apply_ytdlp_patches): o yt-dlp usa
# lazy loading e resolve a classe pelo nome no modulo original, entao o
# monkey-patch substitui a classe antes de qualquer instanciacao. Ao atualizar
# o yt-dlp o patch continua valendo; descarte quando o PR#17129 sair numa
# release. Motivo completo no README (secao yt-dlp). Os imports foram
# adaptados de relativos (dentro do yt-dlp) para absolutos (pacote yt_dlp).
import json
